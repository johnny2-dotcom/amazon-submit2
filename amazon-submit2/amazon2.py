...
def product_search():
    ...
    for item_url in link_urls:
        ...
        if len(driver.find_elements_by_css_selector('#detailBullets_feature_div > ul > li:nth-child(4) > span > span:nth-child(2)')) > 0:
            if len(driver.find_elements_by_css_selector('#detailBullets_feature_div > ul > li')) == 5:
                asin = driver.find_element_by_css_selector('#detailBullets_feature_div > ul > li:nth-child(4) > span > span:nth-child(2)').text
                asins.append(asin)
            elif len(driver.find_elements_by_css_selector('#detailBullets_feature_div > ul > li')) == 6:
                asin = driver.find_element_by_css_selector('#detailBullets_feature_div > ul > li:nth-child(5) > span > span:nth-child(2)').text
                asins.append(asin)
            elif len(driver.find_elements_by_css_selector('#detailBullets_feature_div > ul > li')) == 2:
                asin = driver.find_element_by_css_selector('#detailBullets_feature_div > ul > li:nth-child(2) > span > span:nth-child(2)').text
                asins.append(asin)
            elif len(driver.find_elements_by_css_selector('#detailBullets_feature_div > ul > li')) == 4:
                asin = driver.find_element_by_css_selector('#detailBullets_feature_div > ul > li:nth-child(3) > span > span:nth-child(2)').text
                asins.append(asin)
            else:
                asin = ''
                asins.append(asin)
